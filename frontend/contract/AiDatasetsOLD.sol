...
contract aiDatasets {
    ...
    function createDataset(
        ...
        _datasetCount++;
        _datasets[_datasetCount] = Dataset({
            datasetId: _datasetCount,
            owner: msg.sender,
            title: _title,
        ...
        isActiveCount++;
        emit DatasetCreated(_datasetCount, msg.sender, _price);
